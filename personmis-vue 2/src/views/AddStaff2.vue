  ...
  <div class="box">
   ...
   <el-row>
    ...
    <el-row>
        ...
        <el-col :span="8">
            <el-form-item label="职务(球场位置)" prop="post_id">
    ...
    <el-row>
        <el-col :span="8">
            <el-form-item label="转会(入职)日期"  prop="entrydate">
                <el-date-picker v-model="addForm.entrydate" type="date" placeholder="选择转会（入职）日期" style="width:100%"></el-date-picker>
            </el-form-item>  
        </el-col>
        <el-col :span="8">
       ...
       <!-- <el-col :span="8">
        ...
        <el-col :span="8">
            <el-form-item label="转会形式" prop="staffsource">
                <el-select v-model="addForm.staffsource" placeholder="请选择转会形式（人员来源）">
    ...
    <el-row>
        <el-col :span="8">
            <el-form-item label="国籍" prop="nativeplace">
                <el-input v-model="addForm.nativeplace"  placeholder="请输入国籍"></el-input>
            </el-form-item>
        </el-col>
        <el-col :span="8">
    ...
    <el-row>
        ...
        <el-col :span="8">
            <el-form-item label="当前身价(英镑)" prop="value">
                <el-input v-model="addForm.value"  placeholder="请输入身价"></el-input>
            </el-form-item>
    ...
    <el-row>
        ...
        <el-col :span="8">
            <el-form-item label="能力值" prop="ability">
                <el-input v-model="addForm.university"  placeholder="请输入能力值"></el-input>
            </el-form-item>
        </el-col>
        <el-col :span="8">
            <el-form-item label="球衣号码" prop="number">
                <el-input v-model="addForm.university"  placeholder="请输入球衣号码"></el-input>
            </el-form-item>
        </el-col>
        <!-- <el-col :span="8">
    ...
    <el-row>
        <el-col :span="8">
            <el-form-item label="体重" prop="weight">
                <el-input v-model="addForm.nativeplace"  placeholder="请输入体重"></el-input>
            </el-form-item>
        </el-col>
        <el-col :span="8">
            <el-form-item label="联系电话" prop="stel">
...
export default {
  ...
  data () {
    return {
        ...
        posts: [ {id: '', pname: ''}] ,
        staffsources: [ '自由转会','违约金','转会费（英镑）','其它'] ,
