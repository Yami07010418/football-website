...
export default {
    ...
    methods: {
        ...
        loadStaffs() {
            this.$axios
                .get('/getPlayerByPage?currentPage=' + this.currentPage + '&&pageSize=' + this.pageSize)
                .then(successResponse => {
        ...
        selectStaffsByCon() {
            ...
            this.$axios
                .post('/selectPlayerByCon', this.selectForm)//直接提交表单
                .then(successResponse => {
                    this.tableData = successResponse.data.players
                    this.total = successResponse.data.total
                })
        ...
        update() {
            ...
            this.$axios
                .post('/updatePlayer', this.addForm)//直接提交表单
                .then(successResponse => {
                    if (successResponse.data === "ok") {
