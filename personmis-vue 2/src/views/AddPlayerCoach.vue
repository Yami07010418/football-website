<template>
    ...
    <div class="box">
        ...
        <el-col :span="8">
            ...
            <el-input v-model="addForm.picture" type="hidden" />
            <el-form-item label="照片">
                <!--  eslint-disable  -->
                <template v-slot="scope">
                    <!-- <el-image :src="imgurl" style="width: 100px; height: 100px" /> -->
                    <el-upload action="http://localhost:8443/personmis/fileInit1" list-type="picture-card"
        ...
        add() {
            this.$refs['addForm'].validate((valid) => {
                if (valid) {
                    ...
                    this.$axios
                        .post('/addPlayerCoach',this.addForm)//直接提交表单
                        .then(successResponse => {
                            if (successResponse.data === "ok") {
                                this.$alert('添加成功', { confirmButtonText: '确定' })
                                this.$router.replace({ path: '/football' })
                            } else {
